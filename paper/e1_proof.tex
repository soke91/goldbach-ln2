...
\section{Remaining transcription (T8--T10)}
The MR short-interval regime for $K > x^{1/3}$ (inputs of
Matom\"aki--Radziwi\l{}\l{} class; band measured tame at $0.0023N$,
half-normal $0.84$, with the completion stamps extended to moduli
$2\times 10^6$ across three values of $N$); the gcd paragraph (T9);
and the assembly (T10: dyadic summation, $L^2 \to L^1$, the
fixed-residue $EH_\mu$ shape, the feed into Pan's $f_3$). Each is
transcription against classical statements; none has a parity shape.
