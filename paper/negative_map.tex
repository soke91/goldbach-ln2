...
and seventeen pre-registered closures}

\author{[author]}
\date{Working paper, increment 196 of the \texttt{goldbach-ln2}
program\\
...
\textbf{seventeen pre-registered closures} --- five route adjudications
against the source papers' explicit lemma hypotheses, nine
...
\section{The negative map: seventeen closures}\label{sec:closures}
...
\item The supply side is closed to measurement: the object is
  featureless in every direction with a name, and the seventeen
