...
\item \textbf{The mask is lower order.}
  $\mathrm{Var}(m)/(\mathfrak S N)\propto N^{g}$ with
  $g = -0.489\pm0.005$, so
  $m(N)\asymp\sqrt{\mathfrak S(N)}\,N^{1/4}$. The value still drifts;
  the sign does not, and the sign is what matters --- the mask does not
  threaten $C(N)=o(N)$.
...
is premature at this size rather than wrong. What the window does
measure is the rate: $b$ refits as
$2.7297, 2.7218, 2.7115, 2.6885, 2.6819, 2.6817$, a drift of $0.048$,
against $0.134$ for the intercept.
