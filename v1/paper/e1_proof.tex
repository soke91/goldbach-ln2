% ADVERSARIAL REVIEW (inc. 143): core reductions (T5, T5.1, T6, SEAM
% formalization) REFUTED — see REVIEW_VERDICT.md. T2, T3 and all
% measurements survive. Retained as a record of the attempt.
