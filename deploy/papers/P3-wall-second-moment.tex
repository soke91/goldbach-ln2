...
the gap is a factor $N/\log N$. Second --- and this is what closes the
...
i.i.d. spread was $0.6455$ of the multiplicative --- so significance
...
\label{meas:disc}
$T(x)$ reads $-0.405600,\,-0.405270,\,-0.405286,\,-0.405295$ at
$x=10^4,10^5,10^6,2\cdot10^6$ against $-4/\pi^2=-0.405285$, while the
worst of twenty independent-sign draws on the same support is
$0.020600,\,0.004570,\,0.001214,\,0.000935$. At the top the separation
is about $430$ standard deviations of the sign ensemble.
...
with $a_n=\sqrt{2\log(N/2)}$ and $\AAA=0.787275$. The quantity is
