...
remains closed over its whole weight space (companion paper P2).
...
The no-go of the companion paper costs a factor
...
absolute-value form as written. Second, the no-go of the companion
paper closes extraction \emph{by divisor switching}; the technology of
