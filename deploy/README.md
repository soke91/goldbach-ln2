...
확인했고, 그들의 Theorem 1 과 Corollary 1 은 그대로 성립한다. **결함
자체는 우리 것이 아니다** — S. Zheleznov 가 우리보다 먼저 저자들에게
알렸다. **누락항을 꺼내 닫은 것은 여기서 하는 일이고**, 저자들은 제약을
그대로 두는 쪽으로 고쳐서 그 판에서는 $\Delta$ 가 생기지 않는다. 두 형식은
