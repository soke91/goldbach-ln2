...
def main():
    ...
    head = [
        "STATISTIC: the same set equality, plus the count of",
        "           annihilated pairs over the grids consistent",
        "           with what the stamp publishes about its own.",
        ...
        "       The scan adds k-ranges [k0, k0+1000) for k0 in",
        "       1..64 and offsets j0 in 0..64 of the same N-grid.",
